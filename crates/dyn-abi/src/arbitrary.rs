...
#[cfg(feature = "eip712")]
const IDENT_STRATEGY: &str = alloy_sol_type_str::IDENT_REGEX;
#[cfg(feature = "eip712")]
...
impl DynSolValue {
    /// Generate a [`DynSolValue`] from the given [`DynSolType`].
...
mod tests {
    use super::*;
    #[cfg(feature = "eip712")]
    use alloy_sol_type_str::{is_id_continue, is_id_start, is_valid_identifier};

...
impl EnumCodegen {
    ...
    pub fn expand(self, name: &Ident, crate_path: &TokenStream) -> TokenStream {
        ...
        let uint8 = quote!(#crate_path::sol_data::Uint<8>);
        let uint8_st = quote!(<#uint8 as #crate_path::SolType>);
        ...
        quote! {
            ...
            impl ::core::convert::TryFrom<u8> for #name {
                ...
                #[inline]
                fn try_from(value: u8) -> #crate_path::Result<Self> {
                    match value {
                        #(#index_to_variant)*
                        value => ::core::result::Result::Err(#crate_path::Error::InvalidEnumValue {
                            name: #name_s,
                            value,
                            max: #max,
                        })
            ...
            #[automatically_derived]
            impl #crate_path::SolValue for #name {
                type SolType = Self;
            }

            #[automatically_derived]
            impl #crate_path::private::SolTypeValue<#name> for #name {
                #[inline]
                fn stv_to_tokens(&self) -> #uint8_st::Token<'_> {
                    #crate_path::Word::with_last_byte(*self as u8).into()
                }
            ...
            #[automatically_derived]
            impl #crate_path::SolType for #name {
                type RustType = #name;
                ...
                #[inline]
                fn type_check(token: &Self::Token<'_>) -> #crate_path::Result<()> {
            ...
            #[automatically_derived]
            impl #crate_path::EventTopic for #name {
                #[inline]
                fn topic_preimage_length(rust: &Self::RustType) -> usize {
                    <#uint8 as #crate_path::EventTopic>::topic_preimage_length(&(*rust as u8))
                }

                #[inline]
                fn encode_topic_preimage(rust: &Self::RustType, out: &mut #crate_path::private::Vec<u8>) {
                    <#uint8 as #crate_path::EventTopic>::encode_topic_preimage(&(*rust as u8), out);
                }

                #[inline]
                fn encode_topic(rust: &Self::RustType) -> #crate_path::abi::token::WordToken {
                    <#uint8 as #crate_path::EventTopic>::encode_topic(&(*rust as u8))
                }
            }

            #[automatically_derived]
            impl #crate_path::SolEnum for #name {

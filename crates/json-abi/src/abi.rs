...
impl ContractObject {
    /// Ignores unlinked bytecode when deserializing and returns the contract object.
    pub fn ignore_unlinked_bytecode_and_parse(s: &str) -> Result<Self, serde_json::Error> {

...
/// assert_eq!(
///     amount_in_eth,
///     Into::<U256>::into(parse_units("15.230001000000000000", "ether").unwrap())
/// );
/// assert_eq!(
///     amount_in_gwei,
///     Into::<U256>::into(parse_units("15.230001000000000000", "gwei").unwrap())
/// );
/// assert_eq!(amount_in_wei, Into::<U256>::into(parse_units("15230001000", "wei").unwrap()));
/// ```
///
...
/// assert_eq!(
///     amount_in_wei,
///     Into::<U256>::into(parse_units("15.230001000000000000", "wei").unwrap())
/// );
/// ```

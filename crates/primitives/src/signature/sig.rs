...
impl alloy_rlp::Encodable for Signature {
    ...
    fn length(&self) -> usize {
        let payload_length = self.rlp_rs_len() + self.y_parity.length();
...
impl alloy_rlp::Decodable for Signature {
    fn decode(buf: &mut &[u8]) -> Result<Self, alloy_rlp::Error> {
        ...
        let pre_len = buf.len();
        let decoded = Self::decode_rlp_vrs(buf, bool::decode)?;
...
mod tests {
    ...
    fn signature_rlp_encode() {
        ...
        let expected = "f84380a048b55bfa915ac795c431978d8a6a992b628d557da5ff759b307d495a36649353a0efffd310ac743f371de3b9f7f9cb56c0b28ad43601b4ab949f53faa07bd2c804";

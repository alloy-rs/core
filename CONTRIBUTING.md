# Contributing to alloy-rs

:balloon: Thanks for your help improving the project! We are so happy to have
you!

There are opportunities to contribute to alloy-rs at any level. It doesn't
...
The alloy-rs project adheres to the [Rust Code of Conduct][coc]. This describes
...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in alloy-rs, creating a new issue in the alloy-rs
...
3. By helping to resolve the issue: Typically this is done either in the form of
   ...
   alloy-rs in a concrete and reviewable manner.
...
When opening a new issue in the alloy-rs issue tracker, users will be presented
...
cases should be limited, as much as possible, to using only alloy-rs APIs.
...
functional guidelines of the alloy-rs project.

## Pull Requests

Pull Requests are the way concrete changes are made to the code, documentation,
and dependencies in the alloy-rs repository.
...
example), it is either adding new functionality to alloy-rs or it is fixing
existing, broken functionality. In both of these cases, the pull request should
include one or more tests to ensure that alloy-rs does not regress in the
future.
...
**Any alloy-rs community member is welcome to review any pull request**.

All alloy-rs contributors who choose to review and provide feedback on Pull
...
1. Does this change make sense for alloy-rs?
2. Does this change make alloy-rs better, even if only incrementally?
...
alloy-rs Collaborator landing the Pull Request but they can also be an
...
a particular change that makes alloy-rs better, but the individual might just
not want to have anything to do with alloy-rs ever again. The goal is not just
having good code.

...
mod tests {
    ...
    fn encode_dynamic_array_of_addresses() {
        ...
        let rust = vec![Address([0x11u8; 20]), Address([0x22u8; 20])];
    ...
    fn encode_fixed_array_of_addresses() {
        ...
        let addresses = [Address([0x11u8; 20]), Address([0x22u8; 20])];
    ...
    fn encode_fixed_array_of_dynamic_array_of_addresses() {
        ...
        let fixed = [
            vec![Address([0x11u8; 20]), Address([0x22u8; 20])],
            vec![Address([0x33u8; 20]), Address([0x44u8; 20])],
        ];
    ...
    fn encode_dynamic_array_of_fixed_array_of_addresses() {
        ...
        let dynamic = vec![
            [Address([0x11u8; 20]), Address([0x22u8; 20])],
            [Address([0x33u8; 20]), Address([0x44u8; 20])],
        ];
    ...
    fn encode_dynamic_array_of_dynamic_arrays() {
        ...
        let dynamic = vec![vec![Address([0x11u8; 20])], vec![Address([0x22u8; 20])]];
    ...
    fn encode_fixed_array_of_static_tuples_followed_by_dynamic_type() {
        ...
        let data = (
            [
                ...
                (U256::from(12411), U256::from(451), Address([0x22u8; 20])),
            ],
            "gavofyork".to_string(),
        );
    ...
    fn encode_static_tuple_of_addresses() {
        type MyTy = (sol_type::Address, sol_type::Address);
        let data = (Address([0x11u8; 20]), Address([0x22u8; 20]));

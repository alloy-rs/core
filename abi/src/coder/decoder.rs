...
mod tests {
    ...
    fn decode_static_tuple_of_addresses_and_uints() {
        ...
        let address1 = Address([0x11u8; 20]);
        let address2 = Address([0x22u8; 20]);
    ...
    fn decode_params_containing_dynamic_tuple() {
        ...
        let address1 = Address([0x22u8; 20]);
        let bool1 = true;
        let string1 = "spaceship".to_string();
        let string2 = "cyborg".to_string();
        let tuple = (bool1, string1, string2);
        let address2 = Address([0x33u8; 20]);
        let address3 = Address([0x44u8; 20]);
        let bool2 = false;
    ...
    fn decode_params_containing_static_tuple() {
        ...
        let address3 = Address([0x33u8; 20]);
        let address4 = Address([0x44u8; 20]);
